...
public class PKICertificateInfo {// extends LoggedOnInfo {
	...
	/*
	 * public final static String KEY_PERSONAL_ID = "serialNumber"; private final static String _nameKey = "CN"; private final static String
	 * _organizationKey = "O"; private final static String _countryKey = "C"; private final static String givenNameKey = "givenName"; private final
	 * static String SurNameKey = "SN";
	 */
